...
export default function ManagerLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-1 flex flex-col md:flex-row">
      {/* Sidebar - desktop */}
      <aside className="hidden md:flex flex-col w-56 bg-white border-r border-surface-3 min-h-screen">
        <div className="p-5 border-b border-surface-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-bold text-sm text-gray-900">Visit Tracker</p>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        {/* Mobile header */}
        <header className="md:hidden bg-white border-b border-surface-3 px-4 py-3 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm">Visit Tracker</span>
          </div>
        ...
        {/* Mobile bottom nav */}
        <nav className="md:hidden bg-white border-t border-surface-3 flex sticky bottom-0">
          {navItems.map(item => (
            <NavLink
              key={item.to}
              to={item.to}
